...
if __name__ == '__main__':
    ...
    with open('predictions.csv', mode='a') as csv_file:
        ...
        for i in range(20):        # Number of trials
            ...
            writer.writeheader()
            writer.writerow({'Position1':positions[0],'Position2':positions[1],'Position3':positions[2],'Position4':positions[3],'Position5':positions[4],'Position6':positions[5],'Prediction':result[0],'Result':result[1]})

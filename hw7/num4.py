...
if __name__ == '__main__':
    ...
    with open('fifty1.csv', mode='w') as csv_file:
        fieldnames = ['Position1', 'Position2', 'Position3', 'Position4', 'Position5', 'Position6','PrePercent']
        ...
        while(i<10):
            ...
            for j in range(50):
                for k in range(6):
                    positions[k] = float(pos[k]) + numpy.random.normal(0, 10)
            ...
            if(acc<0.4):
                ...
                print(i)
                writer.writeheader()
                writer.writerow({'Position1':pos[0],'Position2':pos[1],'Position3':pos[2],'Position4':pos[3],'Position5':pos[4],'Position6':pos[5],'PrePercent':acc})
